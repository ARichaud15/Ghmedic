            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="index.html"><i class="fa fa-home nav_icon"></i>Inicio</a>
						</li>

						<li>
							<a href="views/empleados/index.php"><i class="fa fa-home nav_icon"></i>Empleados</a>
						</li>

						<li>
							<a href="#"><i class="fa fa-home nav_icon"></i>Paises</a>
						</li>
					</ul>
